...
#include "../include/OrderHistoryWidget.h"
...
template <> constexpr inline auto OrderHistoryWidget::qt_create_metaobjectdata<qt_meta_tag_ZN18OrderHistoryWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'handleViewOrderDetails'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'handleTrackOrder'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'handleRefreshOrders'
...
void OrderHistoryWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->handleViewOrderDetails(); break;
        case 1: _t->handleTrackOrder(); break;
        case 2: _t->handleRefreshOrders(); break;
        default: ;
        }
    }
    (void)_a;
